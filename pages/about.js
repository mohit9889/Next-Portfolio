...
import { aboutPageSEO } from '@/constants/seo';
        ...
        <div className='mb-[30px] flex flex-col rounded-[10px] bg-blue-dark px-[20px] py-[30px] text-white md:px-[54px] md:py-[46px] xl:flex-row'>
          ...
          <div className='mt-4 max-w-[100%] xl:mt-0 xl:max-w-[60%]'>
            <p className='text-[16px] leading-[20px] md:text-[20px] md:leading-[26px]'>
              ...
              . My passion lies in crafting user-centric experiences as a
              front-end developer. With a keen eye for detail and a love for
              clean code, I specialize in building high-performance websites and
              ...
              my lens. And when I need to recharge, you'll often find me

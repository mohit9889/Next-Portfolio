      ...
      <div className='container mx-auto'>
        ...
        <div className='container mx-auto mb-[30px] rounded-[10px] bg-neon-green px-[20px] py-[50px] md:px-[100px]'>
          ...
          <p className='text-black-trinary mb-4 text-[20px] leading-[25px] md:text-[26px] md:leading-[34px]'>
            ...
            development with expertise in HTML, CSS, JavaScript, React, Node.js,
            Tailwind CSS. I thrive on collaboration and bring experience in
            agile scrum methodologies. Beyond coding, I enjoy photography, and
            exploring music. Let's connect and bring your digital visions to
            life
          </p>
